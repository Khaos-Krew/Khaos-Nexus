...
const required = [
  ...
  'src/backend/providers/idleon-provider.cjs', 'src/backend/providers/pokemon-go-provider.cjs',
  ...
  'src/sentinel/pokemon-go.cjs', 'src/sentinel/role-menu.cjs', 'src/sentinel/role-menu-extension.cjs',
  'src/sentinel/commands.cjs', 'src/sentinel/action-formatters.cjs',
