...
const required = [
  ...
  'src/railway/cephalon-service.cjs', 'src/railway/ascended-service.cjs',
  'src/game-bots/discord-env.cjs', 'src/game-bots/health.cjs', 'src/game-bots/start.cjs',
  'src/sentinel/game-command-ownership.cjs', 'src/sentinel/ascended-runtime.cjs', 'src/sentinel/cephalon-bot.cjs',
