...
const { FUNCTIONAL_ROLES } = require('./sentinel-permissions.cjs');

const ROLE_BINDING_SCHEMA_VERSION = 1;

const STAFF_ROLE_KEYS = Object.freeze({
  OWNER: FUNCTIONAL_ROLES.OWNER,
  COMMUNITY_MANAGER: FUNCTIONAL_ROLES.COMMUNITY_MANAGER,
  ADMIN: FUNCTIONAL_ROLES.ADMIN,
  MODERATOR: FUNCTIONAL_ROLES.MODERATOR,
});
