...
const CAPABILITIES = Object.freeze({
  ...
  'game.server.restart': { risk: 'high', description: 'Run a guarded scheduler/server restart workflow.' },
  'game.server.shutdown': { risk: 'critical', description: 'Issue an owner-authorized direct graceful server shutdown.' },
  'game.server.stop': { risk: 'critical', description: 'Issue an owner-authorized immediate server stop.' },
  'game.player.moderate': { risk: 'high', description: 'Perform operator-level player moderation such as kick.' },
  'game.player.ban': { risk: 'critical', description: 'Ban or unban a game player.' },
