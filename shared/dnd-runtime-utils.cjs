...
const EVENT_TYPES = new Set([...NARRATIVE_EVENT_TYPES,'character.hp.changed','character.condition.applied','character.condition.removed','character.spell_slots.changed','inventory.item.added','inventory.item.removed']);
