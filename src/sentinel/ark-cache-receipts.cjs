'use strict';
const SADDLES=Object.freeze({ Parasaur:'Para',Carbonemys:'Turtle',Trike:'Trike',Pteranodon:'Ptero',Raptor:'Raptor',Carnotaurus:'Carno','Dire Bear':'DireBear',Therizinosaur:'Therizinosaurus',Thylacoleo:'Thylaco',Sarco:'Sarco',Beelzebufo:'Toad',Kaprosuchus:'Kapro',Baryonyx:'Baryonyx',Ankylosaurus:'Ankylo',Doedicurus:'Doed',Sabertooth:'Saber',Argentavis:'Argentavis',Allosaurus:'Allo',Rex:'Rex',Yutyrannus:'Yuty' });
