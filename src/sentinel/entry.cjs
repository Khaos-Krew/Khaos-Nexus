...
const { installArkStaffStatusMonitorExtension } = require('./ark-staff-status-monitor-extension.cjs');
const { installArkStaffClusterUpdatePanelsExtension } = require('./ark-staff-cluster-update-panels-extension.cjs');
...
installArkStaffClusterUpdatePanelsExtension();
