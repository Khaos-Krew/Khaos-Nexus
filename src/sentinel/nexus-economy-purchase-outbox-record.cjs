...
function canonicalRecordPayload(envelope) {
  return {
    ...
    actionSchemaVersion: envelope.schemaVersion,
    ...
    payload: {
      ...
      fulfillment: envelope.payload.fulfillment
    }
  };
}
...
function validateEnvelope(envelope) {
  ...
  if (envelope.schemaVersion !== ACTION_SCHEMA_VERSION) return 'unsupported-action-envelope-schema';
