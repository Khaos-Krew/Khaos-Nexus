...
// Install after the legacy ARK command wrappers are loaded but before bot.cjs
// starts the Discord client. This adds a separate cluster-aware RCON surface
// without changing the existing /ark command contract.
