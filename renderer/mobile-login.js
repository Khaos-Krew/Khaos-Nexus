  ...
  function mount() {
    ...
    panel.innerHTML = `
      ...
      <div class="mobile-safety-callout">
        ...
        <span>The Android app verifies this desktop's certificate first, then signs in with your Nexus username and password. The password is never stored on the phone; Nexus issues a revocable signed device session instead.</span>
      </div>
      ...
      <p class="privacy-note">The desktop stores only a salted scrypt verifier inside Nexus encrypted secrets storage. Legacy one-time pairing remains available as a recovery path. Remote access is intended for a trusted private network or VPN, not direct public Internet exposure.</p>`;
