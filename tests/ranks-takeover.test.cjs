...
test('managed payload preserves legacy content while adding authority and funding disclosures', () => {
...
test('fallback ranks panel contains every Nexus rank and avoids stale hard-coded pricing', () => {
