...
All release candidates must be built from these committed snapshots and pass source-integrity, packaged-runtime, clean-install, and installed-file verification before publication.
