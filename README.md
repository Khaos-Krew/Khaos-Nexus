...
Recent exact-head evidence now includes **PR #411 CI #582**, **PR #410 CI #581**, **PR #405 CI #573**, **PR #398 CI #570**, and **PR #397 CI #568**, in addition to the earlier green rebuild slices. Current `rebuild/nexus-0.1` branch head is `852a6ab1…`, the merge of PR #411. PR #412 is newer proposal work with CI #585 green but remains open/unmerged, so it is not being presented as accepted baseline functionality. Automated CI and hosted telemetry remain supporting evidence, not substitutes for owner/live interaction acceptance.
